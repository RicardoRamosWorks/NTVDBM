...
static const char* UnmountHelper(char umount) {
	...
	if (Drives[i_drive]) {
		...
		case 1:
			return MSG_Get("PROGRAM_MOUNT_UMOUNT_NO_VIRTUAL");
		case 2:
			return MSG_Get("MSCDEX_ERROR_MULTIPLE_CDROMS");
		}
		Drives[i_drive] = 0;
		...
		if (type=="floppy" || type=="dir" || type=="cdrom" || type =="overlay") {
			...
			if (type=="cdrom") {
				...
				case 2  :
					...
					break;
				case 3  :
					WriteOut(MSG_Get("MSCDEX_ERROR_PATH"));
					break;
				case 4  :
...
public:
	void Run(void) {
		...
		if (reg_al==0x80) {
			reg_ax=0x4310;
			CALLBACK_RunRealInt(0x2f);
			Bit16u xms_seg=SegValue(es);
			Bit16u xms_off=reg_bx;
			reg_ah=8;
		...
		if(fstype=="fat") {
			...
			for (i = 0; i < paths.size(); i++) {
				...
				case 2  :
					...
					break;
				case 3  :
					WriteOut(MSG_Get("MSCDEX_ERROR_OPEN"));
					break;
				case 4  :
					WriteOut(MSG_Get("MSCDEX_TOO_MANY_DRIVES"));
					break;
...
void DOS_SetupPrograms(void) {
	...
	MSG_Add("PROGRAM_MOUNT_USAGE",
	        ...
	        "This makes the directory %s act as the C: drive inside NTVDBM.\n"
	...
	MSG_Add("PROGRAM_INTRO",
	        "\033[2J\033[32;1mWelcome to NTVDBM\033[0m, an x86 emulator with sound and graphics.\n"
	        "NTVDBM creates a shell for you which looks like old plain DOS.\n"
	        "\n"
	        ...
	        "For more information about NTVDBM, go to \033[34;1mhttp://RicardoRamosWorks.com\033[0m\n"
	        "\n"
	        "\033[31;1mNTVDBM will stop/exit without a warning if an error occurred!\033[0m\n"
	        "\n"
	        "\n"
	       );
	...
	MSG_Add("PROGRAM_INTRO_CDROM",
	        "\033[2J\033[32;1mHow to mount a Real/Virtual CD-ROM Drive in NTVDBM:\033[0m\n"
	        "NTVDBM provides CD-ROM emulation on several levels.\n"
	        "\n"
	        ...
	        "If it doesn't work you might have to tell NTVDBM the label of the CD-ROM:\n"
	...
	MSG_Add("PROGRAM_INTRO_SPECIAL",
	        ...
	        "\033[33;1mALT-PAUSE\033[0m   : Pause NTVDBM.\n"
	        ...
	        "\033[33;1mCTRL-F9\033[0m     : Kill NTVDBM.\n"
	        "\033[33;1mCTRL-F10\033[0m    : Capture/Release the mouse.\n"
	        "\033[33;1mCTRL-F11\033[0m    : Slow down emulation (Decrease NTVDBM Cycles).\n"
	        "\033[33;1mCTRL-F12\033[0m    : Speed up emulation (Increase NTVDBM Cycles).\n"
	...
	MSG_Add("PROGRAM_BOOT_PRINT_ERROR","This command boots NTVDBM from either a floppy or hard disk image.\n\n"
